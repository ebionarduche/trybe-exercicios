...
const emergencyTaks = document.getElementsByClassName('emergency-tasks')[0];
emergencyTaks.style.backgroundColor = 'rgb(255, 159, 132)';
...
for (let index2 = 0; index2 < noEmergencyTasksHeaders.length; index2 += 1) {
    noEmergencyTasksHeaders[index2].style.backgroundColor = 'rgb(35, 37, 37)';
}
